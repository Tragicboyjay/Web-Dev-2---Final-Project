    ...
    return (
      <Box width="100%" p="2rem">
        ...
        <form onSubmit={handleSignIn} style={{ maxWidth: "400px", margin: "0 auto" }}>
          ...
          <Center>
            <Button background="teal" mb={"1rem"} type="submit">Sign In</Button>
          </Center>
  
          <Text textAlign={"center"}>
            Don&apos;t have an account already? <ChakraLink as={ReactRouterLink} to="/sign_up">Sign up now!</ChakraLink>
          </Text>
        </form>
      </Box>
    );
